...
const SearchBox = () => {
  return (
    <div className="bg-white/50 backdrop-blur-[20px] border border-white/30rounded-2xlshadow-lg p-8grid grid-cols-1
     md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 items-center justify-center gap-8
        mt-4 sm:mt-12 w-[95%] sm:w-[80%] mx-auto">
